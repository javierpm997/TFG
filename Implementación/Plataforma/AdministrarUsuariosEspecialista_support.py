...
def generarTabla():
    ...
    w.Label4 = tk.Label(w.Canvas1, width=60, text='Email', borderwidth=2, relief='ridge')
    w.Label4.grid(row=0, column=3)


    w.Label5 = tk.Label(w.Canvas1, width=20, text='Contraseña', borderwidth=2, relief='ridge')
    w.Label5.grid(row=0, column=4)

    w.Label6 = tk.Label(w.Canvas1, width=5, text='Mod.', borderwidth=2, relief='ridge')
    w.Label6.grid(row=0, column=5)

    w.Label7 = tk.Label(w.Canvas1, width=5, text='Borrar', borderwidth=2, relief='ridge')
    w.Label7.grid(row=0, column=6)
    ...
    if listaUsuarios==99:
        ...
        for i in range(0,len(listaUsuarios)):
            ...
            tk.LabelDinamico = tk.Label(w.Canvas1, width=40, text=listaUsuarios[i][4], borderwidth=2, relief='ridge')
            ...
            tk.BotonDinamico.grid(row=i+1, column=5)
...
def comandoBorrar(pIdUsuarioEspecialista):
    a = BorrarUsuarioEspecialista.vp_start_gui(pIdUsuarioEspecialista)
    for widget in w.Canvas1.winfo_children():
        widget.destroy()
    generarTabla()

def comandoModificar(pIdUsuarioEspecialista):
    a = ModificarUsuarioEspecialista.vp_start_gui(pIdUsuarioEspecialista)
    for widget in w.Canvas1.winfo_children():
        widget.destroy()
    generarTabla()

if __name__ == '__main__':
    import AdministrarUsuariosEspecialista
    AdministrarUsuariosEspecialista.vp_start_gui()
