...
--
-- Host: localhost    Database: cardionline
-- ------------------------------------------------------
...
CREATE TABLE `Especialista` (
  ...
  CONSTRAINT `Especialista_ibfk_1` FOREIGN KEY (`idEspecialista`) REFERENCES `Usuario` (`idUsuario`)
...
INSERT INTO `Estado` VALUES (1,'No Analizado',_binary '0','El ECG no está analizado'),(2,'OK',_binary '0','ECG esta OK'),(3,'Vigilar',_binary '0','Vigilar'),(4,'Acudir a consulta',_binary '0','Acudir a consulta');
...
CREATE TABLE `Paciente` (
  ...
  KEY `especialista` (`especialista`),
  CONSTRAINT `Paciente_ibfk_1` FOREIGN KEY (`especialista`) REFERENCES `Especialista` (`idEspecialista`),
  CONSTRAINT `Paciente_ibfk_2` FOREIGN KEY (`idPaciente`) REFERENCES `Usuario` (`idUsuario`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-05-06  0:20:03
