...
import AnadirTipoAnalisis_support
...
def vp_start_gui():
    ...
    root = tk.Tk()
    top = Toplevel1 (root)
    AnadirTipoAnalisis_support.init(root, top)
    root.mainloop()
...
def create_Toplevel1(rt, *args, **kwargs):
    ...
    w = tk.Toplevel (root)
    top = Toplevel1 (w)
    AnadirTipoAnalisis_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Button1.configure(command=lambda:AnadirTipoAnalisis_support.ejecutar_Aceptar(self.TEntry1.get(),self.TEntry2.get()))
        ...
        self.Button2.configure(command=lambda:AnadirTipoAnalisis_support.destroy_window())
