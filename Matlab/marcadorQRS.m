...
%------ SPECIFY DATA ------------------------------------------------------
PATH= 'C:\Users\javie\Documents\OneDrive - UPV EHU\mit-bih-arrhythmia-database-1.0.0'; % path, where data are saved
HEADERFILE= '100.hea';      % header-file in text format
ATRFILE= '100.atr';         % attributes-file in binary format
DATAFILE='100.dat';         % data-file
SAMPLES2READ=900;         % number of samples to be read
...
ANNOT=round(ANNOT);
ANNOTD= ANNOT(ind);
%------ PRUEBA DERIVADA E INTEGRAL  ---------%
I = M
DM = integral(I(:,1),TIME);
%------ DISPLAY DATA ------------------------------------------------------
